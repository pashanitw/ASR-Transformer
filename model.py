...
class AudioEncoder(nn.Module):
    def __init__(self, n_mels, n_state):
        super().__init__()
        self.conv1 = Conv1d(n_mels, n_state, kernel_size=11, stride=2, padding=2)
        self.conv2 = Conv1d(n_state, n_state, kernel_size=11, stride=2, padding=2)
        self.conv3 = Conv1d(n_state, n_state, kernel_size=11, stride=2, padding=2)
